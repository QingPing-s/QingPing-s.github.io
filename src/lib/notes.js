...
export const noteSections = [
  ...
  },
  {
    ...
    items: [
      ["Agent Evaluation 总览", "evaluation/overview/"],
      ["结果评测 Result Eval", "evaluation/result-eval/"],
      ["轨迹评测 Trajectory Eval", "evaluation/trajectory-eval/"],
      ["工具调用评测 Tool Eval", "evaluation/tool-eval/"],
      ["RAG 评测", "evaluation/rag-eval/"],
      ["LLM-as-Judge 与 Rubric", "evaluation/llm-judge-rubric/"],
    ],
  },
  {
    id: "coding",
